...
#include "../RenderObjects/Texture.h"
#include "Material.h"
...
public:
    ...
    Mesh(vector<Vertex> vertices, vector<unsigned int> indices, vector<Texture> textures, Material material)
    {
        ...
        this->materialProp = material;
        // now that we have all the required data, set the vertex buffers and its attribute pointers.
        setupMesh();
    }

    // render the mesh
    void Draw(Shader& shader, unsigned int reflectTex, unsigned int shadowTex)
    {
        ...
        // send material
        shader.setMaterial("material", materialProp);
        unsigned int i = 0;
